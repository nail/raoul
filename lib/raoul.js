...
function Raoul(options) {
  ...
  function _connect(options) {
    ...
    irc.addListener('001', _connection_init_listener.bind(this));
    irc.addListener('433', _nick_taken_listener.bind(this));
    irc.addListener('privmsg', _privmsg_listener.bind(this));
    irc.addListener('notice', _notice_listener.bind(this));
    irc.addListener('pong', _pong_listener.bind(this));
    irc.connect(_connect_callback.bind(this));
  ...
  function _public_handler(message) {
    ...
    if (!message.addressed) {
      ...
      if (autoreply && !random_reply_cnt--) {
        ...
        this.store.random_reply(function(random) {
